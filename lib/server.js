...
app.put('/categories/:id', (req, res) => {
  ...
  categoriesDB.splice(data, 1, record);
  res.status(200).send(record);
...
app.delete('/categories/:id', (req, res) => {
  let id = req.params.id;
  let data = categoriesDB.forEach((e) => {
    if (e.id == parseInt(id)) {
      // console.log(index);
      return e;
    }
  });
  categoriesDB.splice(data, 1);
...
app.put('/products/:id', (req, res) => {
  ...
  productsDB.splice(data, 1, record);
...
app.delete('/products/:id', (req, res) => {
  let id = req.params.id;
  let data = productsDB.forEach((e, index) => {
    if (e.id == id) {
      return e;
    }
    // }else{
